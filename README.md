# Desarrollo Seguro y Auditoría

## Actividad 1: Modelado de amenazas de una aplicación (grupal)

Este repositorio contiene los entregables de la primera actividad de la materia **Desarrollo Seguro y Auditoría**.
...
Este es un ejercicio práctico de modelado de amenazas, utilizando una herramienta de modelado como Threat Analysis and Modeling Tool (TAMT), de una aplicación web de tres capas para un negocio de pago electrónico de una librería.

Se utiliza la aplicación **Threat Analysis and Modeling Tool (TAMT)** con el propósito de analizar las amenazas de una aplicación web típica de negocio de pago electrónico de una librería (textos, libros, revistas, etc.) en formato digital con opciones de impresión.

### Contenido del repositorio

- **Act1-Modelado_amenazas.tm7**: Archivo de modelado de amenazas generado con TAMT que contiene el análisis completo de la aplicación.

### Documentación en vivo

**Documento de trabajo colaborativo**: [Google Drive - Documento en vivo](https://docs.google.com/document/d/1F9eUwvVt_g_hBTs_iFl4lOeGjxJZWFQjLnREkDu0Ih0/edit?usp=sharing)
